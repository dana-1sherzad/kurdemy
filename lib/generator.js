...
async function createFolderStructure(projectPath, config) {
  const folders = [
    ...
    'src/backend/src/common/guards',
    'src/backend/src/common/interceptors',
    'src/backend/src/common/pipes',
    'src/backend/src/modules',
    'src/backend/src/modules/auth',
    'src/backend/src/modules/users',
    'src/backend/src/modules/auth/strategies',
    'src/backend/src/modules/auth/guards',
    'src/backend/src/modules/auth/services',
    'src/backend/src/modules/auth/controllers',
    'src/backend/src/modules/auth/dtos',
    'src/backend/src/modules/users/services',
    'src/backend/src/modules/users/controllers',
    'src/backend/src/modules/users/dtos',
    
    // Frontend structure
    'src/frontend',
    'src/frontend/components',
    'src/frontend/components/ui',
    'src/frontend/components/sections',
    ...
    'src/frontend/app/api/health',
    'src/frontend/app/api/auth',
    'src/frontend/app/api/users',
    'src/frontend/public',
    'src/frontend/pages/api',
    'src/frontend/pages/api/health',
    'src/frontend/pages/api/auth',
    'src/frontend/pages/api/users',
    'src/frontend/src',
